...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="./dataset/minimind-v_dataset/pretrain_data.jsonl")
    parser.add_argument("--images_path", type=str, default="./dataset/minimind-v_dataset/pretrain_images")
